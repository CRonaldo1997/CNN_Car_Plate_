...
def visualize_boxes_and_labels_on_image_array_modified(image,
                                              center_name_dict,
                                              #NAME_CENTER_DICT,
                                              boxes,
                                              classes,
  ...
  for box, color in box_to_color_map.items():
    ...
    name = box_to_display_str_map[box]
    center_name_dict[centerX] = name
    print('%s center is %f', name, centerX)
  ...
  #return image,NAME_CENTER_DICT
  return image,center_name_dict
